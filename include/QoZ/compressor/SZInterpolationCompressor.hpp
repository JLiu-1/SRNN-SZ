                ...
                if(!meta.adjInterp){
                    ...
                    for (i = 3; i + 3 < n; i += 2) {
                        ...
                        for(j=j_start;j+3<m;j+=4){
                            ...
                            d = data + begin1 + i* stride1+begin2+j*stride2;
                            if(mark[d-data])
                                std::cout<<"e1 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            //predict_error+=quantize_integrated(d - data, *d, interp_linear( interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1))
                            //                                        ,interp_cubic(*(d - stride3x2), *(d - stride2), *(d + stride2), *(d + stride3x2)) ),mode);
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, coeff_x*interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1))
                                                                    //+coeff_y*interp_cubic(*(d - stride3x2), *(d - stride2), *(d + stride2), *(d + stride3x2)) ,mode);
                        }
                        //j=1
                        if(j_start==5){
                            ...
                            d = data + begin1 + i* stride1+ begin2+stride2;
                            if(mark[d-data])
                                std::cout<<"e2 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            //predict_error+=quantize_tuning(d - data, *d, interp_linear( interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1))
                            //                                , interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ),tuning);
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1)),mode);//to determine
                        }
                        ...
                        if(j<m){
                            ...
                            //predict_error+=quantize_integrated(d - data, *d, interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1))
                            //                                ,mode);
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1)),tuning);
                    ...
                    for(j=5;j+3<m;j+=4){
                        d = data + begin1 + stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e4 "<<d-data<<std::endl;
                            mark[d-data]=true;

                        //predict_error+=quantize_integrated(d - data, *d, interp_linear( interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1)),interp_cubic(*(d - stride3x2), *(d - stride2), *(d + stride2), *(d + stride3x2)) ),tuning);
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_cubic(*(d - stride3x2), *(d - stride2), *(d + stride2), *(d + stride3x2)),mode);
                    }
                    //j=1
                    d = data + begin1 + stride1+ begin2+stride2;
                    if(mark[d-data])
                                std::cout<<"e5 "<<d-data<<std::endl;
                            mark[d-data]=true;
   
                    //predict_error+=quantize_integrated(d - data, *d, interp_linear( interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1)), interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ),mode);//bug when no nmcond and n or m<=4, all the following quads has this problem
                    predict_error+=quantize_integrated(d - data, *d,  0,mode);//, coeff_x*interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1))+coeff_y*interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ,mode);//bug when no nmcond and n or m<=4, all the following quads has this problem
                    //j=m-3 or m-2
                    if(j<m-1){
                        d = data +begin1 + stride1+ begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e6 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        //predict_error+=quantize_integrated(d - data, *d, interp_linear(interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1)), interp_quad_2(*(d - stride3x2), *(d - stride2), *(d + stride2)) ),mode);
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//, coeff_x*interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1))+coeff_y*interp_quad_2(*(d - stride3x2), *(d - stride2), *(d + stride2)) ,mode);
                    }
                    else if(j<m){//j=m-1

                        d = data + begin1 + stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e7 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_quad_1(*(d - stride1), *(d + stride1), *(d + stride3x1)),mode);
                    }
                    ...
                    if(j_start==5){
                        ...
                        d = data + begin1 + i*stride1+ begin2+stride2;
                        if(mark[d-data])
                                std::cout<<"e9 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        //predict_error+=quantize_integrated(d - data, *d, interp_linear( interp_quad_2(*(d - stride3x1), *(d - stride1), *(d + stride1)), interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ),mode);
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//, coeff_x*interp_quad_2(*(d - stride3x1), *(d - stride1), *(d + stride1))+coeff_y*interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ,mode);
                    }
                    //j=m-3 or m-2
                    if(j<m-1){
                        ...
                        d = data +begin1 + i*stride1+ begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e10 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        //predict_error+=quantize_integrated(d - data, *d, interp_linear( interp_quad_2(*(d - stride3x1), *(d - stride1), *(d + stride1)), interp_quad_2(*(d - stride3x2), *(d - stride2), *(d + stride2)) ),mode);
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//, coeff_x*interp_quad_2(*(d - stride3x1), *(d - stride1), *(d + stride1))+coeff_y*interp_quad_2(*(d - stride3x2), *(d - stride2), *(d + stride2)) ,mode);
                    }                    
                    //j=m-1
                    else if(j<m){
                        ...
                        d = data + begin1 + i * stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e11 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//,  interp_quad_2(*(d - stride3x1), *(d - stride1), *(d + stride1)),mode);
                    }
                    ...
                    if (n % 2 == 0) {
                        ...
                        if(j_start==5){
                            ...
                            d = data + begin1 + (n-1)*stride1+ begin2+stride2;
                            if(mark[d-data])
                                std::cout<<"e13 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ,mode);
                        }
                        //j=m-3 or m-2
                        if(j<m-1){
                            ...
                            d = data +begin1 + (n-1)*stride1+ begin2+j*stride2;
                            if(mark[d-data])
                                std::cout<<"e14 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, interp_quad_2(*(d - stride3x2), *(d - stride2), *(d + stride2)) ,mode);
                        }
                        //j=m-1
                        else if(j<m){
                            ...
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//, lorenzo_2d(*(d-stride1-stride2),*(d-stride1),*(d-stride2)), mode);
                        } 
                    }
                    ...
                    for (i = 3; i + 3 < n; i += 2) {
                        ...
                        for(j=j_start;j+3<m;j+=4){
                            ...
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//coeff_x*interp_cubic_adj(*(d - stride3x1),*(d - stride2x1), *(d - stride1), *(d + stride1),*(d + stride2x1), *(d + stride3x1))
                        ...
                        */
                        if(j_start==5){
                            ...
                            d = data + begin1 + i* stride1+ begin2+stride2;
                            if(mark[d-data])
                                std::cout<<"e17 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            //predict_error+=quantize_tuning(d - data, *d, interp_linear( interp_cubic(*(d - stride3x1), *(d - stride1), *(d + stride1), *(d + stride3x1))
                            //                                , interp_quad_1(*(d - stride2), *(d + stride2), *(d + stride3x2)) ),tuning);
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);//interp_cubic_adj(*(d - stride3x1),*(d - stride2x1), *(d - stride1), *(d + stride1),*(d + stride2x1), *(d + stride3x1))
                                                            //,mode);//to determine
                        }
                        /*
                        if(mode==-1){
                    ...
                    for(j=3;j+3<m;j+=4){
                        ...
                        d = data + begin1 + stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e19 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        predict_error+=quantize_integrated(d - data, *d, 0,mode);//interp_cubic_adj(*(d - stride3x2),*(d - stride2x2), *(d - stride2), *(d + stride2),*(d + stride2x2), *(d + stride3x2))  ,mode);
                    }
                    /*
                    //j=1
                    d = data + begin1 + stride1+ begin2+stride2;
                    ...
                    */    
                    ...
                    if(j<m-1){
                        ...
                        predict_error+=quantize_integrated(d - data, *d, 0,mode);// coeff_x*interp_quad_1_adj(*(d - stride1), *(d + stride1), *(d + stride2x1))
                    ...
                    //j=m-1
                        ...
                        d = data + begin1 + stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e21 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        predict_error+=quantize_integrated(d - data, *d, 0,mode);// interp_quad_1_adj(*(d - stride1), *(d + stride1), *(d + stride2x1)),mode);//to determine
                    }
                    ...
                    if(j_start==5){
                        ...
                        predict_error+=quantize_integrated(d - data, *d,  0,mode);//coeff_x*interp_quad_2_adj(*(d - stride2x1), *(d - stride1), *(d + stride1))
                    ...
                    //j=m-1
                        ...
                        d = data + begin1 + i * stride1+begin2+j*stride2;
                        if(mark[d-data])
                                std::cout<<"e25 "<<d-data<<std::endl;
                            mark[d-data]=true;
                        predict_error+=quantize_integrated(d - data, *d, 0,mode);// interp_quad_2_adj(*(d - stride2x1), *(d - stride1), *(d + stride1)) ,mode);//to determine
                    }
                    ...
                    if (n % 2 == 0) {
                        ...
                        if(j_start==5){
                            ...
                            d = data + begin1 + (n-1)*stride1+ begin2+stride2;
                            if(mark[d-data])
                                std::cout<<"e27 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            predict_error+=quantize_integrated(d - data, *d,  0,mode);// interp_quad_1_adj(*(d - stride2), *(d + stride2), *(d + stride2x2)) ,mode);
                        }
                        //j=m-3 or m-2
                        if(j<m-1){
                            d = data +begin1 + (n-1)*stride1+ begin2+j*stride2;
                            if(mark[d-data])
                                std::cout<<"e28 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            predict_error+=quantize_integrated(d - data, *d, 0,mode);// interp_quad_2_adj(*(d - stride2x2), *(d - stride2), *(d + stride2)) ,mode);
                        }
                        //j=m-1
                        else if(j<m){
                            d = data + begin1 + (n-1) * stride1+begin2+j*stride2;
                            if(mark[d-data])
                                std::cout<<"e29 "<<d-data<<std::endl;
                            mark[d-data]=true;
                            predict_error+=quantize_integrated(d - data, *d, 0,mode);// lorenzo_2d(*(d-stride1-stride2),*(d-stride1),*(d-stride2)),mode);
                        } 
                    }
